...
def musixmatch_lyrics(song_name: str, song_artist: str) -> Tuple[str, str]:
    ...
    if site != None:
        ...
        if 'lyrics__content__ok' in inspect_element:
            musixmatch_lyric, musixmatch_source = get_web_lyric(inspect_element, 'lyrics__content__ok')
        elif 'lyrics__content__warning' in inspect_element:
            musixmatch_lyric, musixmatch_source = get_web_lyric(inspect_element, 'lyrics__content__warning')
...
def get_web_lyric(inspect_element: str, lyrics_type: str) -> Tuple[str, str]:
    ...
    splitted_inspect_element = inspect_element.split('<span class="' + lyrics_type + '">')
