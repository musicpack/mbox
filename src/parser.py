...
async def parse(context: MusicBoxContext) -> str:
    ...
    Returns:
        str: Status message
    """
    logging.info('Parsing context [{0}]{1}: {2}'.format(
        context.get_guild(), context.get_author(), context.get_str_full_input()))
...
def get_context(message: discord.Message) -> MusicBoxContext:
    pass
